...
* Create a fork of project `mwlarebuilder/mwlarebuilder
  <https://github.com/mwlarebuilder/mwlarebuilder/>`_ on github.
...
* Clone your fork to your local machine.::
    ...
    git clone git@github.com:YOUR_GITHUB_USERNAME/mwlarebuilder.git
    cd mwlarebuilder
...
* Develop your changes (aka "hack")
  ...
  * Incorporate your changes into MwlareBuilder.
...
* Synchronize your fork with the MwlareBuilder upstream repository. There are two
  ways for this:
  ...
  1. Rebase you changes on the current development head (preferred, as it
     results in a straighter history and conflicts are easier to solve)::
      ...
      git remote add upstream https://github.com/mwlarebuilder/mwlarebuilder.git
...
* Open the *Pull Requests* page at
  https://github.com/YOUR_GITHUB_USERNAME/mwlarebuilder/pulls
