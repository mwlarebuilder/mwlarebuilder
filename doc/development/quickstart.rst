...
* Our git repository is at https://github.com/mwlarebuilder/mwlarebuilder::
...
* For new files mind adding the copyright header, see
  |MwlareBuilder/init.py|_
  (also mind updating to the current year).

  .. |MwlareBuilder/init.py| replace:: :file:`MwlareBuilder/__init__.py`
  .. _MwlareBuilder/init.py: https://github.com/mwlarebuilder/mwlarebuilder/blob/develop/MwlareBuilder/__init__.py
