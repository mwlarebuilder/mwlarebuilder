...
The MwlareBuilder project follows the :pep:`8` Style Guide for Python Code for
new code.
...
Before submitting changes to MwlareBuilder, please check your code with both
tools.
