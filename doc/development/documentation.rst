...
MwlareBuilder's documentation is created using Sphinx_.
...
a new version at https://mwlarebuilder.readthedocs.io/en/latest/.


For **small changes** (like typos) you may just fork MwlareBuilder on Github,
...
MwlareBuilder extensions
----------------------------

For the MwlareBuilder documentation there are roles available [*]_
...
* Combining markup and links::
    ...
    The easiest way to install MwlareBuilder is using |pip|_::
