...
1. If you don't have a git clone of MwlareBuilder, first fetch the current
   development head, either using pip, …::

     pip download --no-deps https://github.com/mwlarebuilder/mwlarebuilder/archive/develop.zip
     unzip develop.zip
     cd mwlarebuilder-develop/

   … or using git::

     git clone https://github.com/mwlarebuilder/mwlarebuilder.git
     cd mwlarebuilder
...
.. _tests/README: https://github.com/mwlarebuilder/mwlarebuilder/blob/develop/tests/README.md
...
.. _.travis.yml: https://github.com/mwlarebuilder/mwlarebuilder/blob/develop/.travis.yml

.. |appveyor.yml| replace:: ``appveyor.yml``
.. _appveyor.yml: https://github.com/mwlarebuilder/mwlarebuilder/blob/develop/appveyor.yml
