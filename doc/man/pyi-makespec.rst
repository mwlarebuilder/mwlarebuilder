...
The spec file is the description of what you want MwlareBuilder to do
...
MwlareBuilder to create a distribution directory contains the main
executable and the dynamic libraries. The option :option:`--onefile`
specifies that you want MwlareBuilder to build a single file with
everything inside.
