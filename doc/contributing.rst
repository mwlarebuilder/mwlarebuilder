...
MwlareBuilder is a maintained by a group of volunteers.
All contributions,
like community support, bug reports, bug fixes,
documentation improvements, enhancements and ideas are welcome.

MwlareBuilder is an free software project that is created and
maintained by volunteers.
It lives-and-dies based on the support it receives from others, and the fact
that you're even considering contributing to MwlareBuilder is very
generous of you.

Since as of now all core-developers are working on MwlareBuilder in their
...
<https://github.com/mwlarebuilder/mwlarebuilder/issues/new>`_.
...
* **Answer** |support tickets:|_ Often the user just needs to be pointed
  ...
  .. _`support tickets:`: https://github.com/mwlarebuilder/mwlarebuilder/issues?q=is%3Aopen+is%3Aissue+label%3Akind%3Asupport
...
* **Triage** |open issues,|_ which means: read the report; ask the issue
  ...
  .. _`open issues,`: https://github.com/mwlarebuilder/mwlarebuilder/issues?q=is%3Aopen
...
* **Help improving the documentation:** There is a list of `documentation
  ...
  __ https://github.com/mwlarebuilder/mwlarebuilder/issues?q=is%3Aopen+is%3Aissue+label%3Aarea%3Adocumentation

* **Pick an** |pull-request-issue|_ and provide one.

  .. |pull-request-issue| replace:: **issue requesting a pull-request**
  .. _`pull-request-issue`: https://github.com/mwlarebuilder/mwlarebuilder/issues?q=is%3Aopen+is%3Aissue+label%3A%22pull-request+wanted%22
...
* **Review** |pull requests:|_ Are the commit messages following the
  ...
  .. _`pull requests:`: https://github.com/mwlarebuilder/mwlarebuilder/pulls

* Scan the `list of open issues`__ and pick some task :-)

  __ https://github.com/mwlarebuilder/mwlarebuilder/issues
