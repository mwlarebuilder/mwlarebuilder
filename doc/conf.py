...
# -*- coding: utf-8 -*-
#
# MwlareBuilder documentation build configuration file, created by
...
from MwlareBuilder import __version__
from help2rst import parser_to_rst  # noqa: E402
from MwlareBuilder.__main__ import generate_parser  # noqa: E402
from MwlareBuilder.utils.cliutils import makespec  # noqa: E402
...
# Generate CLI references for ``mwlarebuilder`` and ``pyi-makespec``.
...
for (contents, path) in [
    (parser_to_rst(generate_parser()),
     "_mwlarebuilder-options.tmp"),
    (parser_to_rst(generate_parser(), cross_references=False),
     "man/_mwlarebuilder-options.tmp"),
...
issues_github_path = "mwlarebuilder/mwlarebuilder"
...
def setup(app):
    app.add_css_file('css/mwlarebuilder.css')
...
# of the sidebar.
html_logo = '_static/mwlarebuilder-draft1a-100_trans.png'

# The name of an image file (within the static path) to use as favicon of the
# docs.  This file should be a Windows icon file (.ico) being 16x16 or 32x32
# pixels large.
html_favicon = '_static/mwlarebuilder-draft1a.ico'
...
htmlhelp_basename = 'MwlareBuilderdoc'
...
latex_documents = [
    (master_doc, 'MwlareBuilder.tex', 'MwlareBuilder Documentation',
...
man_pages = [
    ('man/mwlarebuilder', 'mwlarebuilder',
     'Configure and build a MwlareBuilder project in one run',
     ['Hartmut Goebel'], 1),
    ('man/pyi-makespec', 'pyi-makespec',
     'Create a spec file for your MwlareBuilder project',
     ['Hartmut Goebel'], 1)
]
...
texinfo_documents = [
    (master_doc, 'MwlareBuilder', 'MwlareBuilder Documentation',
     author, 'MwlareBuilder', 'One line description of project.',
     'Miscellaneous'),
]
