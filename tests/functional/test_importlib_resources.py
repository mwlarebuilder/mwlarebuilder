...
# validates the behavior of the resource reader implemented by MwlareBuilder's PyiFrozenImporter.
#
...
from MwlareBuilder.utils.tests import skipif
from MwlareBuilder.compat import is_py39, exec_python, exec_python_rc
from MwlareBuilder.utils.hooks import check_requirement
...
# MwlareBuilder, there are actually two slightly different possibilities:
...
#    namespace package ends up being handled by MwlareBuilder's `PyiFrozenImporter`, which requires extra care to ensure
