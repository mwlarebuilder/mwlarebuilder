...
from MwlareBuilder.compat import is_win, is_linux
from MwlareBuilder.utils.tests import importorskip, xfail, skipif, requires
...
def test_sqlite3(pyi_builder):
    pyi_builder.test_source(
        """
        # MwlareBuilder did not included module 'sqlite3.dump'.
        import sqlite3
