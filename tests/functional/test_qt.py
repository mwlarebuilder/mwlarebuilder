...
from MwlareBuilder import isolated
from MwlareBuilder.compat import is_win, is_darwin, is_linux
from MwlareBuilder.utils.hooks import check_requirement, can_import_module
from MwlareBuilder.utils.hooks.qt import get_qt_library_info
from MwlareBuilder.utils.tests import importorskip, requires, skipif
...
def test_Qt_QtQml(pyi_builder, QtPyLib):
    pyi_builder.test_source(
        ...
        # https://github.com/mwlarebuilder/mwlarebuilder/issues/3711.
        #
...
# The alternative of using a newer Appveyor OS `fails <https://github.com/mwlarebuilder/mwlarebuilder/pull/3563>`_.
...
# python module.
# See:
# https://github.com/mwlarebuilder/mwlarebuilder/pull/6496#issuecomment-1011098019
...
def _test_qt_bindings_import(bindings, module, pyi_builder_onedir):
    ...
    # segfaults occur when trying to resolve bundle identifier, which may be related to MwlareBuilder failing to
