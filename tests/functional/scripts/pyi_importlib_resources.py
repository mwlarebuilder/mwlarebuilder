...
# as a frozen application serves as proof of conformance for the MwlareBuilder's reader.
#
...
# MwlareBuilder's custom resource reader, if/when implemented). Without custom resource reader, the frozen version of the
