#-----------------------------------------------------------------------------
# Copyright (c) 2020-2023, MwlareBuilder Development Team.
#
...
# MwlareBuilder. Due to transitivity of test results, this script running without errors both as a native script and
# as a frozen application serves as proof of conformance for the MwlareBuilder's provider.
#
# Wherever the behavior between the native providers is inconsistent, we allow the same leeway for the MwlareBuilder's
# frozen provider.
