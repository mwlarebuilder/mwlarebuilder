#-----------------------------------------------------------------------------
# Copyright (c) 2023, MwlareBuilder Development Team.
#
...
# problems on macOS...), MwlareBuilder needs to be able to rewrite the link to "jump over" the missing intermediate link.
...
# Helper to generate --add-data arguments for MwlareBuilder.
...
# This is a special case, because MwlareBuilder needs to relink file_c to file_a due to missing link (file_b).
...
# This is a special case, because MwlareBuilder needs to relink file_d to file_a due to missing links (file_b, file_c).
