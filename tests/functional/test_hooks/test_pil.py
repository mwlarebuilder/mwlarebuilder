...
from MwlareBuilder.utils.hooks import can_import_module
...
def test_pil_no_tkinter(pyi_builder):
    ...
    pyi_builder.test_source(
        ...
        # successfully excluded Tkinter. To prevent MwlareBuilder from parsing this import and thus freezing this
...
def test_pil_tkinter(pyi_builder):
    ...
    * MwlareBuilder [issue #1584](https://github.com/mwlarebuilder/mwlarebuilder/issues/1584).
    """
    ...
    pyi_builder.test_source(
        ...
        # the exclusion of this package requested by "PIL" package hooks. To ensure MwlareBuilder parses this import
...
def test_pil_no_matplotlib(pyi_builder):
    ...
    pyi_builder.test_source(
        ...
        # Use dynamic import of matplotlib to prevent MwlareBuilder from picking up the import.
        try:
