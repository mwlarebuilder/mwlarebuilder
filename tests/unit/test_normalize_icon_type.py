...
import MwlareBuilder
from MwlareBuilder.building.icon import normalize_icon_type
...
def test_normalize_icon(monkeypatch, tmp_path):
    ...
    icon = str(Path(MwlareBuilder.__file__).with_name("bootloader") / "images" / 'icon-console.ico')
