...
from MwlareBuilder.utils.tests import requires
...
def test_shutdown_timeout_dangling_threads(strict_mode, caplog):
    ...
    This situation might arise when, as part of analysis, MwlareBuilder performs an isolated import of a module
