...
# https://mwlarebuilder.readthedocs.io/en/latest/advanced-topics.html#the-tree-class

import os
import pytest

from os.path import join
import MwlareBuilder.building.datastruct


class Tree(MwlareBuilder.building.datastruct.Tree):
    # A stripped-down version of MwlareBuilder.building.datastruct.Tree that does not check the guts,
...
def test_Tree(monkeypatch, prefix, excludes, result):
    monkeypatch.setattr('MwlareBuilder.config.CONF', {'workpath': '.'})
