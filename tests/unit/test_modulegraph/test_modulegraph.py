...
#            self.assertEqual(description, ('.pyc', 'rb', imp.PY_COMPILED))
            ...
            # FIXME: MwlareBuilder appends `__init__.py` to the pkg-directory
            ...
            if path.endswith('.zip'):
                ...
                # MwlareBuilder (using the import machinery) finds 'myext.py'
...
class TestModuleGraph (unittest.TestCase):
    ...
    def test_determine_parent(self):
        graph = modulegraph.ModuleGraph()
        # FIXME MwlareBuilder: original _load_tail returned a MissingModule if
        # the module was not found. MwlareBuilder changed this in
    ...
    def test_itergraphreport(self):
        ...
        # Travis which uses a virtualenv (MwlareBuilder has a
