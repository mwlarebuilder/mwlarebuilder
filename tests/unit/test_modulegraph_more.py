...
from MwlareBuilder.utils.tests import xfail
...
#-- SWIG packages - mwlarebuilder specific tests
...
def test_swig_import_simple_BUGGY(tmpdir):
    ...
    # Thus the node is still found under its old name. The relevant code was brought from MwlareBuilder to upstream,
    # so this might be MwlareBuilder's fault. See test_swig_import_simple for what it should be.
