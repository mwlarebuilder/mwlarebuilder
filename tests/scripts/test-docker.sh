#!/usr/bin/env bash
#-----------------------------------------------------------------------------
# Copyright (c) 2018-2023, MwlareBuilder Development Team.
#
...
#
# Must be run from the MwlareBuilder project root. Any args
...
# by the MwlareBuilder maintainers. If you find it useful,
...
_image="mwlarebuilder-functional-tests"
